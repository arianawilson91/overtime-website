...
const menuSections = [
  {
    ...
    items: [
      { name: 'Wings', price: '$14.95', desc: 'Tossed in your choice of sauce. Side of Bleu Cheese or Ranch, Celery. 10 count.' },
      ...
      { name: 'Tacos', price: '$14.95+', desc: 'Three tacos, Pico de Gallo, Cheese, Sour Cream. Chicken $14.95 / Shrimp $15.95 / Mahi $16.95.' },
      ...
      { name: 'Nachos', price: '$13.95', desc: 'Queso, Chili, Pico de Gallo, Green Onions, Sour Cream. Add Chicken +$4.' },
      ...
      { name: 'Sampler Platter', price: '$16.95', desc: 'Mozzarella Sticks, Chicken Tenders, Pepperoni Pinwheels, Seasoned Fries, Onion Rings.' },
      ...
      { name: 'Chicken Quesadilla', price: '$14.95', desc: 'Blackened Chicken, Onions, Peppers, Cheddar Jack, Flour Tortilla, Pico, Sour Cream.' },
  ...
  },
  {
    ...
    items: [
      { name: 'Classic Caesar', price: '$10.95', desc: 'Romaine, Parmesan, Croutons, Caesar Dressing.' },
  ...
  },
  {
    ...
    items: [
      ...
      { name: 'Meat Lovers', price: '10" $16.95 / 14" $22.95', desc: 'Pepperoni, Sausage, Ham, Bacon, Meatball.' },
      { name: 'Margherita', price: '10" $14.95 / 14" $19.95', desc: 'Fresh Mozzarella, Tomatoes, Basil, Garlic, Olive Oil.' },
  ...
  },
  {
    ...
    items: [
      { name: 'Philly Cheesesteak', price: '$15.95', desc: 'Shaved Ribeye, Onions, Peppers, Provolone on a hoagie roll.' },
      { name: 'Chicken Philly', price: '$15.95', desc: 'Grilled Chicken, Onions, Peppers, Provolone on a hoagie roll.' },
      { name: 'Classic Burger', price: '$14.95', desc: '8oz patty, Lettuce, Tomato, Onion, Pickle. Add cheese +$1.' },
  ...
  },
  {
    ...
    items: [
      ...
      { name: 'Baby Back Ribs', price: 'Half $18.95 / Full $26.95', desc: 'Slow-cooked, BBQ glazed.' },
      { name: 'Chicken Marsala', price: '$18.95', desc: 'Sauteed Chicken, Mushrooms, Marsala Wine Sauce.' },
      ...
      { name: 'Penne Vodka', price: '$15.95', desc: 'Penne Pasta, Creamy Vodka Sauce. Add Chicken +$5 / Shrimp +$7.50.' },
  ...
  return (
    <div className="pt-20">
      ...
      {menuSections.map(section => (
        <section key={section.id} id={section.id} className="py-16 px-4 even:bg-brand-light-gray odd:bg-white">
          <div className="max-w-5xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {section.items.map(item => (
                <div key={item.name} className="flex justify-between gap-4 border-b border-gray-200 pb-4">
                  <div>
                  ...
                  <div className="font-display text-brand-red tracking-wider whitespace-nowrap">{item.price}</div>
                </div>
              ))}
            </div>
          </div>
